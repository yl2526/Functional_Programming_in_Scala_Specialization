...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  if (($uD(delta.apply__O()) < 0)) {
  ...
  } else if (($uD(delta.apply__O()) === 0.0)) {
    $m_Lcalculator_Signal$();
    var expr$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2) {
      return (function() {
    ...
    $m_Lcalculator_Signal$();
    var expr$2 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2$1, b$2$1, delta$1) {
      return (function() {
        var jsx$5 = $uD(b$2$1.apply__O());
        var x = $uD(delta$1.apply__O());
        var jsx$4 = $uD($g["Math"]["sqrt"](x));
        var jsx$3 = $uD(a$2$1.apply__O());
        var jsx$2 = $uD(b$2$1.apply__O());
        var x$1 = $uD(delta$1.apply__O());
        var array$1 = [((((-jsx$5) + jsx$4) / 2) / jsx$3), ((((-jsx$2) - $uD($g["Math"]["sqrt"](x$1))) / 2) / $uD(a$2$1.apply__O()))];
...
$c_Lcalculator_Polynomial$.prototype.computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c) {
  ...
  var delta = new $c_Lcalculator_Var().init___F0(expr);
  var expr$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$1, b$1, c$1) {
    return (function() {
      var x = $uD(b$1.apply__O());
      return ($uD($g["Math"]["pow"](x, 2.0)) - ((4 * $uD(a$1.apply__O())) * $uD(c$1.apply__O())))
    })
  })(a, b, c));
  $c_Lcalculator_Signal.prototype.update__F0__V.call(delta, expr$1);
  return delta
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(x0$1) {
  if ((x0$1 !== null)) {
    ...
    var exprSig = $as_Lcalculator_Signal(x0$1.$$und2$f);
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, str$1, exprSig$1) {
      return (function() {
        return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(exprSig$1.apply__O()), $as_sci_Map(arg$outer.namedExpressions$1$f.$$minus__O__sc_Map(str$1)))
      })
    })(this, str, exprSig));
    var y = new $c_Lcalculator_Var().init___F0(expr);
    return new $c_T2().init___O__O(str, y)
  } else {
    throw new $c_s_MatchError().init___O(x0$1)
  }
});
